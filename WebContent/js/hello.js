...
(function(hello) {
	...
	hello.init({
		...
		google: {
			...
			// Authorization scopes
			scope: {
				basic: 'https://www.googleapis.com/auth/plus.me profile https://www.googleapis.com/auth/plus.circles.write',
				email: 'email',
				birthday: '',
				events: '',
	...
	hello.init({
		...
		twitter: {
			...
			get: {
				...
				// Https://dev..com/docs/api/1.1/get/statuses/user_timeline
